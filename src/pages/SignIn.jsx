      ...
      <div className='flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto '>
        ...
        <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
          <form onSubmit={onSubmit}>
            ...
            onChange={onChange} placeholder="Enter your email address" 
            ...
            <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg'>
              <p className='mb-6'>Don't have an account? <Link to='/sign-up' className='text-red-600 hover:text-red-700 transition duration-200 ease-in-out font-bold ml-1'>Register</Link></p>
              <p><Link to='/forgot-password' className='text-blue-600 hover:text-blue-800 transition duration-200 ease-in-out font-bold'>Forgot Password</Link></p>
            </div>
